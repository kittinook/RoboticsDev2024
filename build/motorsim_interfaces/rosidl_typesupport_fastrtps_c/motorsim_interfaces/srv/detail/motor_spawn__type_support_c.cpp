...
#include "motorsim_interfaces/srv/detail/motor_spawn__rosidl_typesupport_fastrtps_c.h"
...
using _MotorSpawn_Request__ros_msg_type = motorsim_interfaces__srv__MotorSpawn_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MotorSpawn_Request__ros_msg_type * ros_message = static_cast<const _MotorSpawn_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MotorSpawn_Request__ros_msg_type * ros_message = static_cast<_MotorSpawn_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = motorsim_interfaces__srv__MotorSpawn_Request;
    is_plain =
      (
...
static size_t _MotorSpawn_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_motorsim_interfaces__srv__MotorSpawn_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motorsim_interfaces, srv, MotorSpawn_Request)() {
...
using _MotorSpawn_Response__ros_msg_type = motorsim_interfaces__srv__MotorSpawn_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MotorSpawn_Response__ros_msg_type * ros_message = static_cast<const _MotorSpawn_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MotorSpawn_Response__ros_msg_type * ros_message = static_cast<_MotorSpawn_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = motorsim_interfaces__srv__MotorSpawn_Response;
    is_plain =
      (
...
static size_t _MotorSpawn_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_motorsim_interfaces__srv__MotorSpawn_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motorsim_interfaces, srv, MotorSpawn_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motorsim_interfaces, srv, MotorSpawn)() {
