...
#include "motorsim_interfaces/srv/detail/motor_spawn__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = motorsim_interfaces::srv::MotorSpawn_Request;
    is_plain =
      (
...
static size_t _MotorSpawn_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MotorSpawn_Request(full_bounded, is_plain, 0);
...
{
  return &motorsim_interfaces::srv::typesupport_fastrtps_cpp::_MotorSpawn_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = motorsim_interfaces::srv::MotorSpawn_Response;
    is_plain =
      (
...
static size_t _MotorSpawn_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MotorSpawn_Response(full_bounded, is_plain, 0);
...
{
  return &motorsim_interfaces::srv::typesupport_fastrtps_cpp::_MotorSpawn_Response__handle;
}
...
{
  return &motorsim_interfaces::srv::typesupport_fastrtps_cpp::_MotorSpawn__handle;
}
